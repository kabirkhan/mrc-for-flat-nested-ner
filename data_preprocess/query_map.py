...
path_en_wnut_20_wlp = os.path.join(root_path, "data_preprocess/queries/en_wnut_20_wlp.json")
...
query_en_wnut_20_wlp = load_query_map(path_en_wnut_20_wlp)
...
queries_for_dataset = {
    ...
    "en_wnut_20_wlp": query_en_wnut_20_wlp,
